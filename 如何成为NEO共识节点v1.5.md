...
NEO的节点(neo-cli)会长期获得更新。NEO共识节点的运维者届时会需要对其运行的neo-cli进行更新。以下为大致更新流程：

1. NGD 首先会对最新的neo-cli进行测试。测试没有问题后，首先协调各个测试网共识节点运维者进行升级。
2. 一般情况下，新版本在测试网运行无误2周后，便可以启动主网升级流程。NGD会协调各个主网节点运维者升级其节点。
3. 当主网节点均升级到最新版本时，网络版本升级完成。
